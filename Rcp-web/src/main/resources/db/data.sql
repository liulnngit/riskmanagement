...
INSERT INTO t_sys_account VALUES (1, '4bc5ccdc9eba428fb0514fe001322df4', 'admin', 'cVTn3gyhTusoK9KvLpcuY3uF25wm6Qfg11U4ptyv6/HeyGFd05UkRdoU7CTMrgDCLioz2MxBFla41M7SXn5qwVMdoPW49F3CE3Pt6WF/IDY=', 1, 'tsx@zhiduntech.com', NOW(), 1, 'S', 1, unix_timestamp(now())*1000, 1, unix_timestamp(now())*1000);
