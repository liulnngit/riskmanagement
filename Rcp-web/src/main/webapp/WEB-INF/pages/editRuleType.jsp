					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									<form class="form-horizontal" id="editRuleTypeForm" method="POST" role="form">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													placeholder="请输入规则类别编码" value="${ruleType.code }">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-4 col-sm-offset-2">
												...
												<input type="hidden" id="id" name="id" value="${ruleType.id }">
												<input type="hidden" name="status" value="${ruleType.status }">
												<input type="hidden" name="creatorId"
													value="${ruleType.creatorId }"> <input type="hidden"
													name="createDate" value="${ruleType.createDate }">
											</div>
										</div>
...
<script type="text/javascript">
	$(function() {
		...
		function ajaxSubmitForm() {debugger;
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/editRuleType",
						data : $('#editRuleTypeForm').serialize(),// 你的formid
						async : false,
	...
	$("#resetBtn").click(function() {
		window.location.href = "${pageContext.request.contextPath}/showRuleType?id=" + $("#id").val();
	});
	$("#returnBtn")
			.click(
					function() {
