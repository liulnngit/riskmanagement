					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									<form class="form-horizontal" id="addRiskLevelForm" method="POST"
										role="form">
		...
		function ajaxSubmitForm() {
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/addRiskLevel",
						data : $('#addRiskLevelForm').serialize(),// 你的formid
						async : false,
