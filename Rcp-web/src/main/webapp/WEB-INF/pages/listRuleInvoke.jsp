                ...
                <div class="ibox float-e-margins">
					...
					<div class="panel admin-panel">
							<div class="btn-group" id="toolbar">
								<button type="button" class="btn btn-primary margin-items-top" id="searchBtn"
									data-toggle="modal" data-target="#searchModal">查询</button>
							</div>
							<div class="body-content">
									
										  <table id="tb_listRuleInvoke"></table>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="modal-title" id="myModalLabel">查询规则统计</h4>
									</div>
						...
						<div style="margin-right: 50px; margin-top: 10px; margin-botton: 10px;">
							<div class="input-group">
								<span class="input-group-addon">系统名称:</span> <select id="systemId" required="required" class="form-control" name="systemId">
						...
						<div style="margin-right: 50px; margin-top: 10px; margin-botton: 10px;">
							<div class="input-group">
								<span class="input-group-addon">规则名称:</span> <select id="ruleCode" required="required" class="form-control" name="ruleCode">
									<option value="">-----请选择-----</option>
								</select>
							</div>
						</div>
						...
						<div style="margin-right: 50px; margin-top: 10px; margin-botton: 10px;">
							<div class="input-group">
								<span class="input-group-addon">起始时间:</span> <input class="Wdate form-control" style="height: 34px; border: 1px solid #cccccc;" id="dateFrom" name="dateFrom" type="text" placeholder="请选择起始时间"
						...
						<div style="margin-right: 50px; margin-top: 10px; margin-botton: 10px;">
							<div class="input-group">
								<span class="input-group-addon">结束时间:</span> <input class="Wdate form-control" style="height: 34px; border: 1px solid #cccccc;" id="dateTo" name="dateTo" type="text" placeholder="请选择结束时间"
...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_listRuleInvoke').bootstrapTable({
				url : '${pageContext.request.contextPath }/getListRuleInvoke', //请求后台的URL（*）
				method : 'POST', //请求方式（*）
	...
	$("#submitBtn").click(function() {
		...
		$('#tb_listRuleInvoke').bootstrapTable('destroy');
		var oTable = new TableInit();
		oTable.Init();
		$('#tb_listRuleInvoke').bootstrapTable('hideColumn', 'id');
