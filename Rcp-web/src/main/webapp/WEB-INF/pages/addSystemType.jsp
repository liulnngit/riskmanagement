					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									...
									<form class="form-horizontal" id="addSystemTypeForm" role="form">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													required="required" placeholder="请输入系统名称">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													required="required" placeholder="请输入系统代码">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													required="required" placeholder="请输入IP地址">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
				                  ...
				                  required="required" placeholder="请输入公司地址">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													required="required" placeholder="请输入公司域名(格式：http://...或https://...)">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input
													...
													required="required" placeholder="请输入联系人">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													...
													required="required" placeholder="请输入联系电话">
											</div>
										</div>
										<div class="hr-line-dashed"></div>
										<div class="form-group">
		...
		function ajaxSubmitForm() {
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/addSystemType",
						data : $('#addSystemTypeForm').serialize(),// 你的formid
						async : false,
