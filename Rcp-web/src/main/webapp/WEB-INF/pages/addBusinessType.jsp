					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									<form class="form-horizontal" id="addBusinessTypeForm" method="POST"
										role="form">
		...
		function ajaxSubmitForm() {
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/addBusinessType",
						data : $('#addBusinessTypeForm').serialize(),// 你的formid
						async : false,
