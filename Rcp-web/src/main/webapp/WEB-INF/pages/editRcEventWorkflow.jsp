					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
								...
								<form class="form-horizontal" id="editProcessingTypeForm"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="processType"
												...
												placeholder="请输入处理类型名称" value="${rcEventflow.processType }">
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="processTypeEn"
												...
												value="${rcEventflow.processTypeEn }">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea id="remark" name="remark" class="form-control"
												rows="3" placeholder="备注">${rcEventflow.remark}</textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
...
<script type="text/javascript">
	$(function() {
		...
		$(function() {
			// 在键盘按下并释放及提交后验证提交表单
			$("#editProcessingTypeForm").validate({
		...
		function ajaxSubmitForm() {
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/editRcEventflow",
						data : $('#editProcessingTypeForm').serialize(),// 你的formid
						async : false,
	...
	$("#resetBtn")
			.click(
					function() {
						window.location.href = "${pageContext.request.contextPath}/toEditRcEventflowPage?id=" + $("#id").val()
					});
	$("#returnBtn")
			.click(
					function() {
