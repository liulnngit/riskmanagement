					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									<form class="form-horizontal" id="addPayclassForm" method="POST"
										role="form">
		...
		function ajaxSubmitForm() {
			$
					.ajax({
						cache : false,
						type : "POST",
						url : "${pageContext.request.contextPath }/addPayclass",
						data : $('#addPayclassForm').serialize(),// 你的formid
						async : false,
