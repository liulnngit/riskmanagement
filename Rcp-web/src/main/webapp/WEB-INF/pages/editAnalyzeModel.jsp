					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									...
									<form class="form-horizontal" id="editAnalyzeModelForm" method="POST" role="form">
					    			<div class="form-group">
					    				...
					    				<div class="form-group">
											...
											<div class="col-sm-8">
												<textarea rows="5" cols="" disabled="disabled" class="form-control">${configParameterValues}</textarea> 
											</div>
										</div>
										<div class="hr-line-dashed"></div>
					    				<div class="form-group">
					    				...
					    				<div class="form-group">
											<label class="col-sm-2 control-label"><span style="color:red;font-size:18px;">* </span>说&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;明:</label>
											<div class="col-sm-8">
												<textarea class="form-control" id="remark"  name="remark" required="required" placeholder="请输入模型说明" rows="8" cols="10">${analyzeModel.remark }</textarea>
											</div>
										</div>
										<div class="hr-line-dashed"></div>
						             ...
						             <div class="btn-group">
										...
										<input type="hidden" id="id" name="id" value="${analyzeModel.id }">
										<input type="hidden" name="status" value="${analyzeModel.status }">
										<input type="hidden" name="creatorId" value="${analyzeModel.creatorId }">
										<input type="hidden" name="createDate" value="${analyzeModel.createDate }">
											</div>
										</div>
...
<script type="text/javascript">
		...
		function ajaxSubmitForm() {
			$
				.ajax({
					cache : false,
					type : "POST",
					url : "${pageContext.request.contextPath }/editAnalyzeModel",
					data : $('#editAnalyzeModelForm').serialize(),// 你的formid
					async : false,
	...
	$("#resetBtn").click(function(){
		window.location.href = "${pageContext.request.contextPath}/showAnalyzeModel?id=" + $("#id").val();
	});
	$("#returnBtn").click(
	    function() {
	      window.location.href = "${pageContext.request.contextPath}/listAnalyzeModel";
