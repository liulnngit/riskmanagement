					...
					<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="btn-group" id="toolbar">
								...
								<button type="button" class="btn disabled" id="editBtn">导出</button>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<h4 class="modal-title" id="myModalLabel">查询经办件</h4>
											</div>
							...
							<div class="body-content">
								<table id="tb_mylistDoneTask"></table>
...
<script type="text/javascript">
	$(function() {
		...
		$('#tb_mylistDoneTask').bootstrapTable('hideColumn', 'id');//隐藏某一列
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_mylistDoneTask')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath }/getListDoneTask', //请求后台的URL（*）
								method : 'get', //请求方式（*）
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var e = '<button id="showBtn" href="${pageContext.request.contextPath }/showHistoryData?taskId='+row.id
														+ '"data-toggle="modal"  data-target="#myModal"'
													 	+ 'class="btn btn-primary margin-items-top">查看审核记录</button>';
												return e;
											}
										} ],
	...
	$("#submitBtn").click(function() {
		...
		$("#endDate").val(endDate);
		$('#tb_mylistDoneTask').bootstrapTable('destroy');
		var oTable = new TableInit();
		oTable.Init();
		$('#tb_mylistDoneTask').bootstrapTable('hideColumn', 'id');//隐藏某一列
...
<script type="text/javascript">
		function showHistory(id) {
			var pageUrl = "${pageContext.request.contextPath}/showHistoryData?taskId="+ id
			var diag = new Dialog();
			diag.Width = 800;
			diag.Height = 500;
			diag.Title = "查看历史审核记录";
