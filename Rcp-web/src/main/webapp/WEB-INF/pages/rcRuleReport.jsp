...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_listrcRule').bootstrapTable({
				url : '${pageContext.request.contextPath }/getRcRuleReportData', //请求后台的URL（*）
				method : 'get', //请求方式（*）
				...
				sortName : 'executeTimes',//初始化的时候排序的字段
				sortOrder: "asc", //排序方式
				//sortOrder : "desc", //排序方式
	...
	$("#searchBtn").click(function() {
		...
		$("#date").val(searchDate);
		$('#tb_listrcRule').bootstrapTable('destroy');
		var oTable = new TableInit();
		oTable.Init();
	});
