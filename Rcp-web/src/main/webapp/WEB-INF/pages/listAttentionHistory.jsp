					...
					<div class="ibox-content">	
						<div class="panel admin-panel">
							...
							<div class="body-content">
										...
										<table id="tb_attentionhistory"></table>
										<input type="hidden" id="sMerchantId" name="sMerchantId" value="${merchantId }">
										...
										<form id="searchForm">
											<div style="margin-right:50px;margin-top:10px;margin-botton:10px;">
											     <div class="input-group">
												      ...
												      <input id="merchantId" name="merchantId" type="text" class="form-control" placeholder="请输入查询内容"/>               
											      </div>
										    </div>
										</form>
									</div>
...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_attentionhistory').bootstrapTable({
				url : '${pageContext.request.contextPath}/getListAttentionHistory', //请求后台的URL（*）
				method : 'POST', //请求方式（*）
	...
	$("#submitBtn").click(function() {
		...
		$('#tb_attentionhistory').bootstrapTable('destroy');
		var oTable = new TableInit();
		oTable.Init();
		$('#tb_attentionhistory').bootstrapTable('hideColumn', 'id');//隐藏某一列
