                	...
                	<div class="ibox-title">
						...
						<div class="panel admin-panel">
							<div class="body-content">
								<input type="hidden" id="t_merchantId" name="t_merchantId" value="${merchantId}">
								<table id="tb_txdata"></table>
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_txdata')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath }/getMerchantOrderData', //请求后台的URL（*）
								method : 'post', //请求方式（*）
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row, index) {
												var s = '<font color="red"><span>' + value + '</font><span>';
												return s;
											}
										},
										{
