					...
					<div class="panel admin-panel">
						<!-- <div class="btn-group" id="toolbar">
							<button type="button" class="btn btn-primary margin-items-top"
								id="editSysParameter">修改</button>
						</div> -->
						<div class="body-content">
							
									<table id="tb_listSysParameter"></table>
...
<script type="text/javascript">
	$(function() {
		...
		$('#tb_listSysParameter').bootstrapTable('hideColumn', 'id');//隐藏某一列
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_listSysParameter')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath }/getListSysParameter', //请求后台的URL（*）
								method : 'post', //请求方式（*）
...
<script type="text/javascript">
	function edit(id) {
		window.location.href = "${pageContext.request.contextPath}/toEditSysParameterPage?id=" + id;
	}
</script>
