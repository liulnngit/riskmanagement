            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<table id="tb_listDoubtfulOrder"></table>
					</div>
					</div>
...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_listDoubtfulOrder')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath }/getDoubtfuleOrderReport', //请求后台的URL（*）
								method : 'post', //请求方式（*）
	...
	$("#searchBtn").click(function() {
		$('#tb_listDoubtfulOrder').bootstrapTable('destroy');
