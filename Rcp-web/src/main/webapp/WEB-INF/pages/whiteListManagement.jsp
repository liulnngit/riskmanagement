				...
				<div class="ibox-content">
						<div class="panel admin-panel">
							<div class="body-content">
									...
									<form method="post" id="whiteForm" class="form-horizontal" role="form">
									...
									<div class="form-group">
											<label class="col-sm-2 control-label">设置原因:</label>
											<div class="col-sm-8">
												<textarea id="remark" name="remark" class="form-control" rows="3" placeholder="请输入设置白名单"></textarea>
											</div>
										</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
...
<script type="text/javascript">
	...
	/*			merchantId : {
					required : true,
					remote : {
						url : "whiteLibrary/checkMerchantId",
						type : "post",
						dataType : "json",
						data : {
							merchantId : function() {
	...
	*/
	...
	function ajaxSubmitForm() {	
		...
		$
				.ajax({
					url : "${pageContext.request.contextPath }/addWhiteUser",
					cache : false,
					type : "post",
					data : {whiteUser : data},// 你的formid
					async : false,
					dataType : "json",
										...
										.alert(
												'保存成功！',
												{
													...
													time : 2000,
														...
														window.location.href = "${pageContext.request.contextPath }/searchWhiteList";
													}
												});
								//后端响应后放开按钮
								$("#submitBtn").removeAttr("disabled");
