...
<script type="text/javascript">
	...
	$("#searchBtn").click(function() {
		$('#tb_listPay').bootstrapTable('destroy');
...
<script type="text/javascript">
		function showDetail(payclassId, startTime, endTime,userId) {
			var pageUrl = "${pageContext.request.contextPath}/showRcEventDetail?payclassId="+ payclassId + "&detailType=PayDetail" + "&startTime=" + startTime + "&endTime=" + endTime+"&systemId=" + userId
			var diag = new Dialog();
			diag.Width = 1000;
			diag.Height = 500;
			diag.Title = "查看交易趋势图";
